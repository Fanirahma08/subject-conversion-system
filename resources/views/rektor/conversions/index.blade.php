...
@section('title', 'Persetujuan Rektor')

@section('content')
<div class="max-w-7xl mx-auto py-2 px-2">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Persetujuan Konversi (Rektor)</h1>
        <p class="mt-1 text-sm text-slate-500">Tinjau permintaan konversi yang telah disetujui Dekan untuk diterbitkan SK.</p>
    </div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                        <a href="{{ route('rektor.conversions.show', $conv) }}"
                            class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-lg shadow-emerald-500/20 transition-all active:scale-95 leading-none">
                            Tinjau
                        </a>
                    </td>
                </tr>
