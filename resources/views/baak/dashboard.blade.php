...
<div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Tinjauan BAAK</h1>
        <p class="mt-1 text-sm text-slate-500">Persetujuan dan pemrosesan administrasi konversi mata kuliah.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white p-8 rounded-2xl shadow-sm ring-1 ring-slate-200 hover:shadow-md transition-shadow group">
            ...
            <p class="text-sm text-slate-500 mb-6">Tinjau dan verifikasi usulan konversi mata kuliah dari Kaprodi sebelum diteruskan ke Dekan.</p>
            <a href="{{ route('baak.conversions.index') }}" class="inline-flex items-center text-sm font-semibold text-indigo-600 hover:text-indigo-700">
