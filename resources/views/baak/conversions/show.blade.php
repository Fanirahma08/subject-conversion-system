...
@section('title', 'Tinjauan Konversi (BAAK)')
...
<div class="max-w-7xl mx-auto py-2 px-2">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 text-sm text-slate-400 font-medium">
            <li><a href="{{ route('baak.conversions.index') }}" class="hover:text-blue-600 transition-colors">Tinjauan</a></li>
            ...
            <li class="text-slate-900 font-bold">Persetujuan BAAK</li>
        </ol>
    </nav>
        ...
        <div class="xl:col-span-12 2xl:col-span-8 space-y-6">
            ...
            <div class="bg-white rounded-3xl shadow-xl ring-1 ring-slate-200 overflow-hidden">
                <div class="px-6 py-6 border-b border-slate-100">
                    <h3 class="text-sm font-bold text-slate-800 mb-4">Persetujuan BAAK</h3>
                    <form action="{{ route('baak.conversions.update', $conversion) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="4" class="w-full px-4 py-3 rounded-2xl border border-slate-200 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none" placeholder="Catatan untuk Kaprodi, Dekan, atau Mahasiswa...">{{ $conversion->notes }}</textarea>
                        </div>
